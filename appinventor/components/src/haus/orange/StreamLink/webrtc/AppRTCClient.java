...
public interface AppRTCClient {
	...
	class SignalingParameters {
		...
		public SignalingParameters(List<PeerConnection.IceServer> iceServers, boolean initiator, String clientId,
				String wssUrl, String wssPostUrl, SessionDescription offerSdp, List<IceCandidate> iceCandidates) {
	...
	interface SignalingEvents {
		/**
		 * Callback fired once the room's signaling parameters SignalingParameters are
		 * extracted.
		 */
